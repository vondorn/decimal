...
START_TEST(s21_div1) {
  ...
  // 6304515890613543884634146341
  origin.bits[0] = 0b11111111010000110100011000100101;
  origin.bits[1] = 0b01000000111011011101110000101000;
...
START_TEST(s21_div2) {
  ...
  src1.bits[0] = 0b00000000000110100001000001000000;
  src1.bits[1] = 0b00000000000010000000001000000000;
  src1.bits[2] = 0b10000000000000000000;
  src1.bits[3] = 0b00000000000000100000000000000000;
  src2.bits[0] = 0b00000000000000000000001010000000;
  src2.bits[1] = 0b00000000000010000000000000100000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  ...
  value_type_result = s21_div(src1, src2, &result);
  value_type_origin = 0;
  // 42947051.689987184152000001615
  origin.bits[0] = 0b00000100110111101111011001001111;
  origin.bits[1] = 0b00110100111000011010001110111011;
  origin.bits[2] = 0b10001010110001001111011111110001;
...
START_TEST(s21_div3) {
  ...
  value_type_result = s21_div(src1, src2, &result);
  value_type_origin = 0;
  origin.bits[0] = 0b00001110100001010101110110110010;
  origin.bits[1] = 0b01000010011110110010100011011100;
  origin.bits[2] = 0b00011100100000011101101110111010;
...
END_TEST
START_TEST(s21_div5) {
  s21_decimal src1, src2, origin = {0}, result;
  int value_type_result, value_type_origin;
  // src1 = 78228162514264337593543950335;
  // src2 = 0.1;
  src1.bits[0] = 0b00010111111111111111111111111111;
  src1.bits[1] = 0b01100000001011110111111111000011;
  src1.bits[2] = 0b11111100110001001101000111000011;
  src1.bits[3] = 0;
  src2.bits[0] = 1;
  src2.bits[1] = 0;
  src2.bits[2] = 0;
...
START_TEST(s21_div6) {
  ...
  // src1 = 12345;
  // src2 = 78;
  src1.bits[0] = 0b11000000111001;
  src1.bits[1] = 0b0;
  src1.bits[2] = 0b0;
  src1.bits[3] = 0b0;
  src2.bits[0] = 0b1001110;
  src2.bits[1] = 0b0;
  src2.bits[2] = 0b0;
  src2.bits[3] = 0b0;
  value_type_result = s21_div(src1, src2, &result);
  value_type_origin = 0;
  // 158.26923076923076923076923077
  origin.bits[0] = 0b10010010111011000100111011000101;
  origin.bits[1] = 0b00110000001000111110110110011100;
  origin.bits[2] = 0b110011001000111011100101010011;
...
void srunner_arithmetics_tests(SRunner *sr) {
  ...
  tcase_add_test(TestCase1, s21_div3);
  tcase_add_test(TestCase1, s21_div4);
  tcase_add_test(TestCase1, s21_div5);
  tcase_add_test(TestCase1, s21_div6);
  tcase_add_test(TestCase1, s21_div7);
  tcase_add_test(TestCase1, s21_div8);
  tcase_add_test(TestCase1, s21_div9);
